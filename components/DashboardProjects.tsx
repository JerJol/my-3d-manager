        ...
        <div className="space-y-8">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    <div className="relative group flex-1 md:w-64">
                        ...
                        <input
                            ...
                            className="w-full bg-card border border-border/50 rounded-lg py-2 pl-9 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all placeholder:text-primary/60 text-foreground"
                            value={search}
                    ...
                    <button
                        ...
                        className="bg-primary hover:bg-blue-500 text-foreground rounded-lg px-4 py-2 text-sm font-medium flex items-center gap-2 transition-colors shadow-lg shadow-blue-500/20 whitespace-nowrap"
                    >
                ...
                <button
                    ...
                    className={clsx(
                        ...
                        selectedCategoryId === "all"
                            ? "bg-primary border-primary text-foreground shadow-lg shadow-blue-500/20"
                            : "bg-card border-border/50 text-slate-400 hover:border-slate-700 hover:text-slate-200"
                    )}
                >
            ...
            {projects.length === 0 ? (
                <div className="bg-card/50 border border-border/50 rounded-xl p-20 text-center">
                    ...
                    <p className="text-muted-foreground">Utilisez le bouton "Nouveau projet" pour commencer.</p>
                </div>
                ...
                <div className="bg-card/30 border border-dashed border-border/50 rounded-xl p-12 text-center">
                    ...
                    <p className="text-sm text-primary/60">Essayez de modifier vos filtres ou votre recherche.</p>
                    <button
                        onClick={() => {
                            setSearch("");
