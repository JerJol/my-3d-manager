...
INSERT INTO "new_Project" ("createdAt", "description", "filamentId", "id", "isDefault", "localFolderPath", "name", "parentProjectId", "printerId", "status", "tags", "theme", "updatedAt", "versionName", "versionNumber") SELECT "createdAt", "description", "filamentId", "id", "isDefault", "localFolderPath", "name", "parentProjectId", "printerId", "status", "tags", "theme", "updatedAt", "versionName", "versionNumber" FROM "Project";
DROP TABLE "Project";
